...
public class CategoryController {
    ...
    public ResponseEntity<?> getRestaurantCategory(@RequestHeader("Authorization") String jwt) throws Exception {

        User user=userService.findUserByJwtToken(jwt);

        return new ResponseEntity<>(categoryService.findCategoryByRestaurantId(user.getId()),HttpStatus.OK);
